                    ...
                    <form id="formHeader">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="nobl">No BL/ Surat Jalan/ PTs</label>
                                <input type="text" class="form-control" name="nobl" id="nobl" value="<?= $noso; ?>" readonly>
                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-sm-2">
                                                        ...
                                                        <input type="text" name="qty" id="qty<?= $no; ?>" class="form-control" value="<?= $s['qty_aktual']; ?>">
                                                    </div>
                                                    <div class="form-group col-sm-2">
        ...
        $(".sippan").click(() => {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= base_url('deliverynote/createDnx'); ?>",
                        method: 'POST',
                        data: formx,
